...
<div>
    ...
    <div id="v-for-object" class="demo">
        <div v-for="(value, position) in AllPlayers" :key="position" class="data-team__info">
            ...
            <div v-for="(key, index) in value" :key="index" class="data-player__conteiner">
                <!-- <div v-if="key.league == 'Premier League'"> -->
               
                  <!-- <div class="data-player__info">{{ key.number !== null ? key.number : "-"}}</div> -->
